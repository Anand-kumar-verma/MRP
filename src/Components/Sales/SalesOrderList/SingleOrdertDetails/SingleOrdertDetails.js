...
import { getSalesOrdereById } from "../../../../Services/Sales/GetSalesOrderById";
import { IoIosAddCircle } from "react-icons/io";
import { BiEdit } from "react-icons/bi";
import { Button } from "@mui/material";
import { updateSalesOrderByIdFn } from "../../../../Services/Sales/UpdateSalesOrderById";
const SingleOrdertDetails = () => {
  ...
  function saveFunctionCalled(message) {
    handleSubmit((data) => {
      ...
      updateSalesOrderByIdFn({
        formData: formData,
        setloding,
        navigate,
        link: "/sales-order_list",
        reset,
        id: order_id,
      });
    })();
                ...
                <div className="h-full">
                  <div className="grid grid-cols-3 gap-5 pt-5">
                    <TextField
                      ...
                      defaultValue={orderDetails?.customer}
...
export default SingleOrdertDetails;
