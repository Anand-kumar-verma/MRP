...
import { changeSalesOrderStatus } from "../../../Services/Sales/ChangeOrderStatus";
import { getSalesOrderList } from "../../../Services/Sales/GetSalesOrderListWithPagination";
...
export default function SalesOrderList() {
  ...
  const columns = [
    { id: "name", label: "Order No." },
    { id: "code", label: "Customer", align: "" },
    {
      id: "population",
      label: "Exp-Date",
                    ...
                    product.map((row, index) => (
                      <StyledTableRow key={index}>
                        ...
                        >
                          {
                            <span
                              ...
                              onClick={() =>
                                navigate(
                                  `/sales/single-product-details/${row?.id}`
                                )
                              }
                            >
                              {row?.order_number}
                        ...
                        <StyledTableCell
                          ...
                          className="capitalize"
                        >
                          {new Date(row?.expected_data).toDateString()}
                        </StyledTableCell>
                        <StyledTableCell
                          component="th"
                          scope="row"
                        ...
                        <StyledTableCell
                          component="th"
                          scope="row"
                          className="capitalize hover:bg-green-300 hover:px-2 hover:py-2 rounded"
